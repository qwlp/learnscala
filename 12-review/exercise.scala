// Lesson 12: Capstone Project - Student Grade Management System
// Complete the TODO sections to build a full application
...
case class Student(id: String, name: String, email: String) {
  // TODO 1: Implement a method to display student info
  def displayInfo: String = ???
}

case class Course(id: String, name: String, credits: Int) {
  // TODO 2: Validate that credits are between 1 and 6
  require(???, "Credits must be between 1 and 6")
}

case class Grade(studentId: String, courseId: String, score: Double) {
  // TODO 3: Validate score is between 0.0 and 100.0
  require(???, "Score must be between 0.0 and 100.0")
  
  // TODO 4: Convert numeric score to letter grade
...
object DataService {
  ...
  // TODO 5: Load students from CSV file
  ...
  // TODO 6: Load courses from CSV file
  // Format: id,name,credits
  def loadCourses(filename: String): List[Course] = ???
  
  // TODO 7: Load grades from CSV file
  // Format: studentId,courseId,score
  def loadGrades(filename: String): List[Grade] = ???
  
  // TODO 8: Save students to CSV file
  ...
  // TODO 9: Save courses to CSV file
  def saveCourses(courses: List[Course], filename: String): Unit = ???
  
  // TODO 10: Save grades to CSV file
...
class GradeService(
  ...
  // TODO 12: Remove a student by ID (and their grades)
  ...
  // TODO 14: Get all grades for a specific student
  ...
  // TODO 15: Calculate GPA for a student (weighted by credits)
  ...
  // TODO 16: Find top N students by GPA
  def topStudents(n: Int): List[(Student, Double)] = {
    students.flatMap { student =>
      calculateGPA(student.id).map(gpa => (student, gpa))
    }.sortBy(???) // Sort by GPA descending
     .take(n)
  }
  
  // TODO 17: Get students who haven't completed any courses
  def studentsWithoutGrades: List[Student] = {
    students.filter(s => ???)
  }
  
  // TODO 18: Calculate average score for a course
...
object ReportService {
  ...
  // TODO 19: Generate a detailed report for a student
  ...
  // TODO 20: Generate a class summary report
  ...
  // TODO 21: Generate a course statistics report
...
object StudentGradeSystem extends App {
  ...
  // TODO 22: Load data and create GradeService
